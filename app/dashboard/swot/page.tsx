...
import { SwotContent } from './content'
...
export default async function SwotPage() {
  ...
  return (
    <PremiumGate
      isPremium={isPremium}
      featureName="SWOT Analysis"
      description="Auto-derived Strengths, Weaknesses, Opportunities, and Threats for each startup — generated from scoring metrics, financial signals, and competitive landscape data."
    >
      <SwotContent />
    </PremiumGate>
  )
