...
export const PRODUCTS: Product[] = [
  {
    ...
    description:
      "Engineering Software & Industrial AI — 150+ page analysis covering 550+ companies, $15.5B in VC funding, M&A trends, and 5-year market forecasts.",
    priceInCents: 499900, // $4,999
    mode: "payment",
    features: [
      "150+ page deep-dive analysis",
      "550+ companies, $15.5B VC funding mapped",
